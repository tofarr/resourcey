...
``examples.message_board.app:create_app`` assembles a runnable FastAPI app via
...
or directly with uvicorn::
    ...
    uvicorn examples.message_board.app:create_app --factory --reload
"""
...
import examples.message_board.resources  # noqa: F401
from examples.message_board.config import MessageBoardConfig

...
class TestDuplicateClassRejection:
    def test_duplicate_definition_detected(self):
        ...
        # subclassing the shared V2DupBase, are flagged as duplicates.
        import v2_dup_helper_a  # noqa: F401
        import v2_dup_helper_b  # noqa: F401
        from v2_dup_base import V2DupBase

        clear_subclass_cache()
        with pytest.raises(ValueError, match="Duplicate class definition"):
            _get_checked_concrete_subclasses(V2DupBase)
        clear_subclass_cache()
